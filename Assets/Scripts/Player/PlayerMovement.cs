...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        movementSettings.LockMovement = true;
        mouseLook.CanLook = false;
    }

    private void SleepController_OnWakeUp()
    {
        movementSettings.LockMovement = false;
        mouseLook.CanLook = true;
    }

    private void UIEventHandler_OnUIDisplayed(bool state)
    {
        movementSettings.LockMovement = state;
        mouseLook.CanLook = !state;
    }
    ...
    private void Update()
    {
        ...
        if (CrossPlatformInputManager.GetButtonDown("Jump") && !m_Jump && !movementSettings.LockMovement)
        {
            m_Jump = true;
        }
    }
    ...
    private Vector2 GetInput()
    {
        ...
        // Check movement lock
        if (movementSettings.LockMovement)
            input = Vector2.zero;
